...
var _allow_node2d = false setget _private_set, _private_get		#Enables manipulation of Node2D nodes and not just control
...
#		node.set_rotation(target_pos.angle_to_point(container_center))
	else:
